...
app = FastAPI(title="Robo Advisor A2A Server")

# Initialize agent
robo_advisor = RoboAdvisorAgent()
...
async def agent_card():
    ...
    return {
        ...
        "capabilities": robo_advisor.get_capabilities(),
        ...
        "contact": {
            "support_url": "http://localhost:8100/support",
            "documentation_url": "http://localhost:8100/docs",
        ...
        "metadata": {
            ...
            "domain": "finance",
            "tags": ["investment", "portfolio", "robo-advisor", "financial-analysis"],
        },
    }
...
async def handle_task_create(task_id: str, params: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        result = await robo_advisor.process_request(content, user_id)
...
async def health_check():
    ...
    return {"status": "healthy", "agent": "robo_advisor", "timestamp": datetime.now().isoformat()}


@app.get("/capabilities")
async def get_capabilities():
    """Get agent capabilities"""
    return {"capabilities": robo_advisor.get_capabilities(), "agent_name": "Robo Advisor Agent"}
