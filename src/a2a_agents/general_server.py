...
async def initialize_general_agent() -> GeneralAgent:
    """Initialize the General Agent"""
    logger.info("Initializing General Agent...")
    agent = await GeneralAgent.create()
...
async def lifespan(app):
    ...
    # Startup: Initialize the general agent
    logger.info("Starting up General Agent...")
    general_agent = await initialize_general_agent()

    yield

    # Shutdown: Clean up resources if needed
    logger.info("Shutting down General Agent...")
    general_agent = None
